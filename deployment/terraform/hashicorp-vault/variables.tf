...
# variable "access_key" {
#   default = "${data.vault_generic_secret.awscredentials.data["access_key"]}"
# }
# variable "secret_key" {
#   default =  "${data.vault_generic_secret.awscredentials.data["secret_key"]}"
# }
...
variable "instance_vpc_id" {
  type    = string
  default = "vpc-0952ad70f99b10fe2"
}

variable "instance_subnet_id" {
  type    = string
  default = "subnet-0088eee8f7b69af85"
}
